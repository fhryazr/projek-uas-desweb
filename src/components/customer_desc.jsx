...
export default function Customer_desc() {
  const customers = [
    ...
    },
    {
      nama: "Paxel",
      deskripsi:
        "Paxel adalah perusahaan pengiriman berbasis teknologi yang berkomitmen untuk menyelesaikan tantangan jarak jauh di Indonesia. Kami terinspirasi oleh generasi urban, bersemangat dan sadar sosial yang menjadi pola pikir inovasi desain kami. Inilah mengapa kami fokus untuk memberikan pengalaman yang digerakkan oleh pelanggan yang memungkinkan kenyamanan dan kontrol.",
    ...
    },
    {
      nama: "Wahyoo",
      deskripsi:
        "Wahyoo adalah sebuah perusahaan startup asal Indonesia yang berfokus pada sektor makanan dan restoran. Wahyoo berusaha untuk mendukung usaha kecil dan menengah di industri makanan dengan menyediakan platform yang membantu mereka untuk meningkatkan efisiensi operasional, manajemen inventori, dan meningkatkan kehadiran digital mereka.",
    ...
    },
    {
      nama: "Cisco",
      deskripsi:
        "Cisco adalah perusahaan teknologi global yang terkenal karena menyediakan berbagai solusi jaringan dan teknologi informasi. Didirikan pada tahun 1984, Cisco Systems, Inc. memiliki markas besar di San Jose, California, dan telah menjadi pemimpin dalam industri teknologi dan jaringan.",
    ...
    },
    {
      nama: "Legoas",
      deskripsi:
        "Dalam pelaksanaan dan pengembangan sistem lelang, Legoas telah menjadi balai lelang pertama yang melakukan proses lelang secara online dan terus mengembangkan teknologinya untuk selalu menjadi yang terbaik.",
    ...
    },
    {
      ...
      deskripsi:
        "Universitas Airlangga (UNAIR) adalah sebuah perguruan tinggi di Indonesia yang memiliki sejarah panjang dan prestasi yang mengesankan. Universitas ini didirikan pada tanggal 10 November 1954 di Surabaya, Jawa Timur, Indonesia. Pendirinya adalah sekelompok pemikir dan pemimpin masyarakat yang termotivasi untuk menyediakan pendidikan tinggi berkualitas dan berperan dalam pengembangan ilmu pengetahuan serta kesejahteraan masyarakat.",
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 px-10 mt-16">
        {customers.map((customer, index) => (
          <div
            key={index}
            className="flex flex-col md:flex-row mt-16 p-4 px-16 gap-4 w-full">
            ...
            <div className="flex flex-col h-auto justify-between">
              <div>
                ...
                <h2 className="mt-4 text-gray-500 text-[12px] font-medium">
                  {customer.deskripsi}
                </h2>
              </div>
              <h3 className="mt-8 text-slate-500 font-medium">
                {customer.ceo}
              </h3>
            </div>
          </div>
